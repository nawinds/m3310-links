...
Префикс категории удаляется из отображаемого текста уведомления. Если после него указаны две непустые строки, первая становится заголовком, а вторая — сообщением. Если строка одна, заголовком будет «Обновление сайта», а строка коммита станет сообщением.
